...
`rv32m` 是一个 SystemVerilog RV32IM 五级流水 CPU 工程。当前重点是 RTL 仿真、core/AHB directed case、回归自动化、FSDB/Verdi 调试，以及基础 DC 综合流程。
...
```text
core regress: /home/ic/project/rv32m/regress/results/20260513_080708
  builtin + 19 asm: PASS

AHB regress:  /home/ic/project/rv32m/regress/results/20260513_080752
  builtin: SKIP
  19 asm: PASS

performance smoke:
  core: /home/ic/project/rv32m/regress/results/20260513_173555
  AHB:  /home/ic/project/rv32m/regress/results/20260513_173617
  4 perf asm: PASS
```
...
/home/ic/project/
  ...
  rv32m/
    ...
    regress/
      README.md
      env.sh                 兼容入口，内部 source /home/ic/project/rv
...
`source rv` 会设置 `RV32M_ROOT`、`TOOLCHAIN`、`PREFIX`、`VCS_HOME`、`VERDI_HOME`、`NOVAS_HOME`、`DC_HOME`、`SNPSLMD_LICENSE_FILE`、`RV32M_FILELIST_CORE`、`RV32M_FILELIST_AHB`。

兼容旧习惯：

```bash
cd /home/ic/project/rv32m
source regress/env.sh
```

`regress/env.sh` 现在只是 wrapper，会 source `/home/ic/project/rv`。
